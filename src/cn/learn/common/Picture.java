...
public final class Picture implements ActionListener {
   ...
   /**
    ...
    /**
     * Returns the color of pixel ({@code col}, {@code row}) as a 32-bit integer.
     * Using this method can be more efficient than {@link #get(int, int)} because
     * it does not create a {@code Color} object.
     *
     * @param col the column index
     * @param row the row index
     * @return the 32-bit integer representation of the color of pixel ({@code col}, {@code row})
     * @throws IndexOutOfBoundsException unless both {@code 0 <= col < width} and {@code 0 <= row < height}
     *
     * @deprecated Replaced by {@link #getARGB(int col, int row)}.
     */
    @Deprecated
    public int getRGB(int col, int row) {
        return getARGB(col, row);
    }
   ...
   /**
     ...
     * @param col the column index
     * @param row the row index
     * @param rgb the 32-bit integer representation of the color
     * @throws IndexOutOfBoundsException unless both {@code 0 <= col < width} and {@code 0 <= row < height}
     *
     * @deprecated Replaced by {@link #setARGB(int col, int row, int argb)}.
     */
    @Deprecated
